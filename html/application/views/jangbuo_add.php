    ...
    function cal_prices()
    {
        ...
        form1.bigo.focus();
                ...
                <tr>
                    ...
                    <td width="80%" align="left">
                        <div class="form-inline">
                            <input type="number" id="numo" name="numo" class="form-control form-control-sm" onchange="cal_prices();">
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <div align="center">
                <a href="/~four13/jangbuo/add"><input type="submit" value="저장" class="btn btn-sm mycolor1"></a>
                <a href="/~four13/jangbuo/"><input type="button" value="이전버튼" class="btn btn-sm mycolor1"></a>
            </div>
        </form>