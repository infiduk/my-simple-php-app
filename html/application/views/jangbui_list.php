...
<script>
  function find_text()
{
    form1.action="/~four13/jangbui/lists/text1/" + form1.text1.value + "/page";
    form1.submit();
}
$(function() {
        ...
        <form name="form1" action="" method="post">
            <div class="row">
                ...
                <div class="col-9" align="right">           
                      <a href="/~four13/jangbui/add<?=$tmp; ?>" class="btn btn-sm mycolor1">추가</a>
                </div>
            </div>
        </form>
...
<tr>
    <td><?=$no; ?></td>
    <td><?=$writeday ?></td>
    <td><a href="/~four13/jangbui/view/no/<?=$no; ?><?=$tmp; ?>"><?=$product_name ?></a></td>
