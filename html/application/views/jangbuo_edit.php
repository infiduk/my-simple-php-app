    ...
    function cal_prices()
    {
        ...
        form1.bigo.focus();
                ...
                <tr>
                    ...
                    <td width="80%" align="left">
                        <div class="form-inline">
                            <input type="number" name="numo" class="form-control form-control-sm" value="<?=$numo ?>" onchange="cal_prices();">
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <div align="center">
				<a href="/~four13/jangbuo/edit/<?=$tmp; ?>"><input type="submit" value="저장" class="btn btn-sm mycolor1">
                <a href="/~four13/jangbuo/del<?=$tmp; ?>"><input type="button" value="삭제" class="btn btn-sm mycolor1"></a>
            </div>
        </form>