        ...
        <form name="form1" method="POST">
            <table class="table table-bordered table-sm mymargin5">
                ...
                <tr>
                    ...
                    <td width="80%" align="left">
                        <div class="form-inline">
                            <input type="text" name="uid" class="form-control form-control-sm" value="<?=$row->uid13; ?>">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="80%" align="left">
                        <div class="form-inline">
                            <input type="text" name="pwd" class="form-control form-control-sm" value="<?=$row->pwd13; ?>">
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <div align="center">
				<a href="/~four13/member/edit/<?=$tmp; ?>"><input type="submit" value="저장" class="btn btn-sm mycolor1">
                <a href="/~four13/member/del<?=$tmp; ?>"><input type="button" value="삭제" class="btn btn-sm mycolor1"></a>
            </div>
        </form>