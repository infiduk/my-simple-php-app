  ...
  function find_text()
{
    if (!form1.text1.value)       // 값이 없는 경우, 전체 자료
        form1.action="/~four13/gubun/lists";
    else                                    // 값이 있는 경우, text1 값 전달
        form1.action="/~four13/gubun/lists/text1/" + form1.text1.value;
    form1.submit();
}
</script>
<?     
        ...
        <form name="form1" action="" method="post">
            <div class="row">
                ...
                <div class="col-9" align="right">           
                      <a href="/~four13/gubun/add<?=$tmp; ?>" class="btn btn-sm mycolor1">추가</a>
                </div>
            </div>
        </form>
...
<tr>
    <td><?=$no; ?></td>
    <td><a href="/~four13/gubun/view/no/<?=$no; ?><?=$tmp; ?>"><?=$row->name13; ?></a></td>
</tr>
<?
    }
?>
