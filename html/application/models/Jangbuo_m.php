<?
    class Jangbuo_m extends CI_Model												// 모델 클래스 선언
    {
        public function getlist($text1, $start, $limit)
		{
			...
			from jangbu13 left join product13 on jangbu13.product_no13=product13.no13 where jangbu13.io13=1 and jangbu13.writeday13='$text1' 
		...
		{
			$sql="select * from jangbu13 where io13 = 1 and writeday13 = '$text1'";
